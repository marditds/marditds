    ...
    return (
        <Row className='justify-content-center mt-3 mb-4'>
            ...
            <Row xs={2} sm={3} className='my-sm-4 icon--row'>
                ...
                <Col className='icon--col'>
                    <SiVisualstudiocode size={55} />Visual Studio Code
                </Col>
                <Col className='icon--col' >
                    <SiAdobedreamweaver size={55} />Adobe Dreamweaver
                </Col>
            </Row>
            <Row xs={2} sm={3} className='icon--row'>
                <Col className='icon--col my-4 my-sm-0'>
                    <SiAdobephotoshop size={55} />Adobe Photoshop
                </Col>
                <Col className='icon--col my-4 my-sm-0'>
                    <SiEclipseide size={55} />Eclipse
                </Col>
            </Row>
        </Row>
    )
