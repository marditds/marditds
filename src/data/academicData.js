...
export const academicData = [{
    ...
    myrole: 'As a Computer Science BS senior project at California State University of Northridge, I served as the frontend developer using ReactJS. I handled user registration, integrated the MetaMask crypto wallet, and developed the audio player for seamless playback. Additionally, I actively contributed to the user interface decision-making process.'
}]